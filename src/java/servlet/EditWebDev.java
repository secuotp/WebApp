...
public class EditWebDev extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(WebDev.editAddress(address_id, address, city, country_id, postal_code));
        System.out.println(WebDev.editWebDev(user_id, email, firstname, lastname, address_id));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(EditWebDev.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
